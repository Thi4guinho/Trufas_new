...
const renderContent = () => {
    switch (activeTab) {
      ...
      case 'members':
        return <CompanyMembersManager companyId={profile?.companyId} currentUserEmail={user?.email} settings={settings} />;
      default:
        return (
          <div className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <button 
                ...
                className="p-6 bg-white dark:bg-zinc-900 rounded-[2rem] border border-[#141414]/5 dark:border-zinc-50/10 shadow-sm hover:shadow-md transition-all flex items-center justify-between group text-left"
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="font-black tracking-tighter italic text-lg text-[#141414] dark:text-zinc-100">Configurações Gerais</h4>
                    <p className="text-[10px] font-bold text-[#141414]/40 dark:text-zinc-400 uppercase tracking-widest mt-0.5">Ajustes gerais e regras de volume</p>
                  </div>
                </div>
                <ChevronRight size={20} className="text-[#141414]/20 dark:text-zinc-600 group-hover:text-[#141414] dark:hover:text-zinc-100 transition-colors" />
              </button>
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="font-black tracking-tighter italic text-lg text-[#141414] dark:text-zinc-100">Histórico de Vendas</h4>
                    <p className="text-[10px] font-bold text-[#141414]/40 dark:text-zinc-400 uppercase tracking-widest mt-0.5">Ver e gerenciar todas as vendas</p>
                  </div>
                </div>
                <ChevronRight size={20} className="text-[#141414]/20 dark:text-zinc-600 group-hover:text-[#141414] dark:hover:text-zinc-100 transition-colors" />
              </button>
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="font-black tracking-tighter italic text-lg text-[#141414] dark:text-zinc-100">Pagamentos Pendentes</h4>
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="font-black tracking-tighter italic text-lg text-[#141414] dark:text-zinc-100">Registro de Produtos</h4>
                    <p className="text-[10px] font-bold text-[#141414]/40 dark:text-zinc-400 uppercase tracking-widest mt-0.5">Sabores, quantidade e custos</p>
                  </div>
                </div>
                <ChevronRight size={20} className="text-[#141414]/20 dark:text-zinc-600 group-hover:text-[#141414] dark:hover:text-zinc-100 transition-colors" />
              </button>
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="font-black tracking-tighter italic text-lg text-[#141414] dark:text-zinc-100">Registro de Clientes</h4>
                    <p className="text-[10px] font-bold text-[#141414]/40 dark:text-zinc-400 uppercase tracking-widest mt-0.5">Carteira e histórico dos compradores</p>
                  </div>
                </div>
                <ChevronRight size={20} className="text-[#141414]/20 dark:text-zinc-600 group-hover:text-[#141414] dark:hover:text-zinc-100 transition-colors" />
              </button>
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="font-black tracking-tighter italic text-lg text-[#141414] dark:text-zinc-100">Ações de Segurança</h4>
                    <p className="text-[10px] font-bold text-[#141414]/40 dark:text-zinc-400 uppercase tracking-widest mt-0.5">Consultar logs de auditoria</p>
                  </div>
                </div>
                <ChevronRight size={20} className="text-[#141414]/20 dark:text-zinc-600 group-hover:text-[#141414] dark:hover:text-zinc-100 transition-colors" />
              </button>
              ...
              >
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-rose-50 text-rose-600 rounded-2xl flex items-center justify-center group-hover:bg-rose-600 group-hover:text-white dark:hover:text-zinc-900 transition-colors">
                    <UserPlus size={24} />
                  </div>
                  <div>
                    <h4 className="font-black tracking-tighter italic text-lg text-[#141414] dark:text-zinc-100">Gestão de Sócios</h4>
                    <p className="text-[10px] font-bold text-[#141414]/40 dark:text-zinc-400 uppercase tracking-widest mt-0.5">Controlar acessos e permissões</p>
                  </div>
                </div>
                <ChevronRight size={20} className="text-[#141414]/20 dark:text-zinc-600 group-hover:text-[#141414] dark:hover:text-zinc-100 transition-colors" />
              </button>
            ...
            <div className="pt-8 border-t border-[#141414]/5 dark:border-zinc-50/10 space-y-4">
              {/* Report Export Button */}
              <button 
                onClick={() => downloadFullReportPDF(sales, truffles, customers, settings)}
                className="w-full p-6 bg-indigo-600 text-white dark:text-zinc-900 rounded-[2rem] hover:bg-indigo-700 transition-all flex items-center justify-between group text-left shadow-lg"
              >
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-white/20 dark:bg-zinc-900/20 rounded-2xl flex items-center justify-center">
                    <FileText size={24} />
                  </div>
                  <div>
                    <h4 className="font-black tracking-tighter italic text-lg">Exportar Relatório Geral</h4>
                    <p className="text-[10px] font-bold uppercase tracking-widest opacity-80">Baixar balanço de caixa e clientes em PDF</p>
                  </div>
                </div>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        placeholder="APAGAR"
                        className="w-full p-4 bg-white dark:bg-zinc-900 rounded-xl border border-red-200 font-bold text-center"
                      />
                    </div>
                    ...
                    <div className="flex gap-2">
                      <button 
                        ...
                        className="flex-1 p-4 bg-white dark:bg-zinc-900 text-red-600 font-bold rounded-xl hover:bg-red-100 transition-colors"
                      >
                        Cancelar
                      </button>
                      <button 
        ...
        <div className="flex items-center gap-4">
          {activeTab !== 'menu' && (
            <button 
              ...
              className="w-12 h-12 bg-white dark:bg-zinc-900 rounded-2xl border border-[#141414]/5 dark:border-zinc-50/10 flex items-center justify-center hover:bg-[#141414] dark:hover:bg-zinc-100 hover:text-white dark:hover:text-zinc-900 transition-all shadow-sm"
            >
          ...
          <div>
            <h2 className="text-3xl font-black tracking-tighter italic">
              {activeTab === 'pricing' ? 'Configurações Gerais' : 
               ...
               activeTab === 'truffles' ? 'Registro de Produtos' :
               activeTab === 'customers' ? 'Controle de Clientes' :
               activeTab === 'logs' ? 'Logs de Auditoria' : 
               activeTab === 'members' ? 'Gestão de Sócios' : 'Configurações'}
            </h2>
            <p className="text-[10px] font-black text-[#141414]/40 dark:text-zinc-400 uppercase tracking-widest">
